<div class="card px-2 py-4 mt-3 search-result overflow-hidden card-body-hover">
  <!-- <img src='https://i.pinimg.com/564x/fa/df/be/fadfbe0164fe6ed9b9439684c05cc9c5.jpg' alt=""> -->
  <a href="{!! route('compare') !!}" type="button" class="m-4 btn btn-theme position-absolute top-0 end-0 px-3 py-2" style="z-index:15; border-radius:8px 30px 30px 30px;" name="button"> Compare </a>
